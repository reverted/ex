...
// Source: github.com/reverted/ex/server (interfaces: Processor)
...
func (m *MockProcessor) Process(arg0 context.Context, arg1 []map[string]interface{}) ([]map[string]interface{}, error) {
	m.ctrl.T.Helper()
